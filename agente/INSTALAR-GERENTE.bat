@echo off
chcp 65001 >nul 2>&1
title CH.Com Cofre - Instalacao (GERENTE)
...
:executar
cd /d "%~dp0"
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0instalar-cofre.ps1" -Gerente

rem ESTE ARQUIVO NAO VAI PARA CARTORIO NENHUM. Ele instala a versao que le o
rem parque inteiro do bucket, com a tela "Todos os cartorios". Nos clientes,
rem use o INSTALAR.bat.
